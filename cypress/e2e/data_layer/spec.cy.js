...
describe('Data Layer', function () {
  ...
  describe('Data Features with persistence', function () {
    it('should login, submit feedback, wait for user input to create steps, browse thread history, delete a thread and then resume a thread', function () {
      login();
      feedback();
      threadQueue();
      threadList();
