...
class TestAutoConnectMcpServers:
    ...
    @patch('chainlit.mcp_connection.config')
    @patch('chainlit.mcp_connection.context')
    @patch('chainlit.mcp_connection._connect_single_server')
    async def test_auto_connect_enabled_servers(self, mock_connect, mock_context_module, mock_config_module, mock_config, mock_context):
        """Test that only auto_connect=True servers are connected."""
        mock_config_module.return_value = mock_config
        mock_context_module.return_value = mock_context
    ...
    @patch('chainlit.mcp_connection.config')
    @patch('chainlit.mcp_connection.context')
    async def test_mcp_disabled(self, mock_context_module, mock_config_module, mock_config, mock_context):
    ...
    @patch('chainlit.mcp_connection.config')
    @patch('chainlit.mcp_connection.context')
    async def test_no_servers_configured(self, mock_context_module, mock_config_module, mock_config, mock_context):
    ...
    @patch('chainlit.mcp_connection.config')
    @patch('chainlit.mcp_connection.context')
    async def test_no_session_available(self, mock_context_module, mock_config_module, mock_config):
        """Test that auto-connection handles missing session gracefully."""
        mock_context_module.session = None
        mock_config_module.return_value = mock_config
    ...
    @patch('chainlit.mcp_connection.context')
    @patch('chainlit.mcp_connection._connect_single_server')
    async def test_connection_error_handling(self, mock_connect, mock_context_module, mock_config_module, mock_config, mock_context):
...
class TestConnectSingleServer:
    ...
    @patch('chainlit.mcp_connection.context')
    @patch('chainlit.mcp_connection._establish_connection')
    async def test_connection_timeout(self, mock_establish, mock_context_module, mock_session):
        """Test that connection respects timeout."""
        mock_context_module.session = mock_session
    ...
    @patch('chainlit.mcp_connection.context')
    async def test_no_session_available(self, mock_context_module):
    ...
    @patch('chainlit.mcp_connection.context') 
    async def test_already_connected_server(self, mock_context_module, mock_session):
...
class TestEstablishConnection:
    ...
    @patch('chainlit.mcp_connection.config')
    @patch('chainlit.mcp_connection.context')
    @patch('chainlit.mcp_connection.stdio_client')
    @patch('chainlit.mcp_connection.validate_mcp_command')
    @patch('mcp.ClientSession')
    async def test_stdio_connection(self, mock_client_session, mock_validate, mock_stdio_client, mock_context_module, mock_config_module, mock_config, mock_session):
    ...
    @patch('chainlit.mcp_connection.config')
    @patch('chainlit.mcp_connection.context')
    async def test_unsupported_client_type(self, mock_context_module, mock_config_module, mock_config, mock_session):
    ...
    @patch('chainlit.mcp_connection.config')
    @patch('chainlit.mcp_connection.context')
    async def test_client_type_disabled(self, mock_context_module, mock_config_module, mock_config, mock_session):
