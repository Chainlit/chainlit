...
class AzureADOAuthProvider(OAuthProvider):
    ...
    def __init__(self):
        ...
        self.authorize_params = {
            ...
            "response_type": "code",
            "scope": os.environ.get("OAUTH_AZURE_AD_SCOPES", "https://graph.microsoft.com/User.Read offline_access"),
            "response_mode": "query",
        }
...
class AzureADHybridOAuthProvider(OAuthProvider):
    ...
    def __init__(self):
        ...
        self.authorize_params = {
            ...
            "scope": os.environ.get("OAUTH_AZURE_AD_HYBRID_SCOPES", "https://graph.microsoft.com/User.Read https://graph.microsoft.com/openid offline_access"),
