...
class MysqlSQLAlchemyDataLayer(BaseDataLayer):
    def __init__(
        self,
        conninfo: str,
        ...
        self.engine: AsyncEngine = create_async_engine(
            self._conninfo, connect_args=ssl_args, echo=True
        )
    ...
    async def create_element(self, element: "Element"):
        ...
        query = f"INSERT INTO elements ({columns}) VALUES ({placeholders}) ON DUPLICATE KEY UPDATE {updates};"
            ...
            for step_feedback in steps_feedbacks:
                ...
                if thread_id is not None:
                    ...
                    step_dict = StepDict(
                        ...
                        tags=(
                            str.split(step_feedback.get("step_tags"), ",")
                            if step_feedback.get("step_tags")
                            else []
                        ),
                        input=(
